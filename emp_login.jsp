<%-- 
    Document   : emp_login
    Created on : Mar 13, 2011, 1:19:53 PM
    Author     : Amc College
--%>
...
if(document.login.t1.value=="" && document.login.t2.value=="")
 {
 document.getElementById("uname").innerHTML="<blink>"+"Enter the Username !!!"+"</blink>";
...
<form name="login" method="post" action="fetch1.jsp">
<table border="5" width="100%" height="170">
<tr><td><embed src="swf/main1.swf" width="100%" height="170"></td></tr>
</table>
<ul id="menu">
...
<tr><td>
<fieldset><legend><font color="teal">Employee Login</font></legend>
