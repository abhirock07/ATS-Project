<%-- 
    Document   : view_schedule_detail
    Created on : Mar 19, 2011, 7:10:44 PM
    Author     : Amc College
--%>
...
String query="SELECT fno,fname,splace,dplace,cid,cname,empid,empname,pid,pname FROM air_cargo_service where empid='"+f1+"' and fno='"+f2+"' and cid='"+f3+"'";
...
<tr>
	<td><a href="view_scheduling.jsp"><input type="button" name="back" value="BACK"></a></td>
</tr>
</table>
</body>
</html>
